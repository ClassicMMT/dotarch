...
return {
  ...
  config = function()
    ...
    local function resize_repl(fraction)
    ...
    map("n", "<leader>re", function() resize_repl(0.5) end, { desc = "Expand REPL to half screen" })
    map("n", "<leader>rn", function() resize_repl(0.3) end, { desc = "Narrow REPL to original size" })
